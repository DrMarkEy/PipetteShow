      ...
      >
        ...
        <div class="uk-card-body" style="min-width: 380px;">
          <form class="uk-form-stacked">
            ...
            <div class="uk-margin" v-if="instructionsMode === 3">
              <label class="uk-form-label">Use Multi-Channel Pipettes</label>
              <div class="uk-form-controls">
                <label><input name="multi-channel" type="radio" :value="0" id="multi-channel-pipette-none" v-model="multiChannelPipettes"/>&nbsp;None</label><br/>
