<template>
  <page-layout class="privacy">
    <div class="uk-container">
      <ul uk-tab>
        <li><a href="#"><span class="uk-text-large uk-text-muted">English Version</span></a></li>
        <li><a href="#"><span class="uk-text-large uk-text-muted">German Version</span></a></li>
      </ul>
      ...
      <ul class="uk-switcher uk-margin">
        <li>
          ...
          <p>
            <span>
              <strong>Prof. Dr. Johannes Kabisch</strong><br />

              Department of Biology<br />
              Computer-aided Synthetic Biology<br />
              Technische Universität Darmstadt<br />
              Schnittspahnstr. 12<br />
              64287 Darmstadt<br />
              Germany<br />
            </span>
          </p>
          <p>
            <span>E-Mail: contact@pipette-show.de</span>
          </p>
          ...
          <p>
            ...
            600, San Francisco, CA 94107, USA ("Twitter").
          </p>
          <p>
          ...
          <p>
            ...
            Twitter's servers in the USA. For technical reasons, it is necessary
            for Twitter to process your IP address. In addition, the date and
            time of your visit to our website will also be recorded.
          </p>
          <p>
            If you are logged in to Twitter while visiting one of our plugged-in
            websites, the information collected by the plug-in from your
            specific visit will be recognized by Twitter. The information
            collected may then be assigned to your personal account at Twitter.
            If, for example, you use the Twitter Tweet button, this information
            will be stored in your Twitter account and may be published on the
            Twitter platform. To prevent this, you must either log out of
            Twitter before visiting our site or make the appropriate settings in
            your Twitter account.
          </p>
          <p>
            Further information about the collection and use of data as well as
            your rights and protection options in Twitter's privacy policy found
            at
          </p>
          <p>
        ...
        <li>
          ...
          <p>
            ...
            Version Ihres Internetbrowsers, das Betriebssystem, die Website, von
            der aus Sie auf unseren Internetauftritt gewechselt haben (Referrer
            URL), die Website(s) unseres Internetauftritts, die Sie besuchen,
          ...
          <p>
            ...
            Andernfalls sind die Daten bis zur endgültigen Klärung eines
